<div id="float-consult" class="float-consult visible-lg" style="margin-top: -62px; visibility: visible;">
  <div class="btn-group-vertical">
    <a class="btn btn-consult-default" href="http://wpa.qq.com/msgrd?v=3&uin=1556797870&site=qq&menu=yes&type=left"  data-toggle="tooltip" data-placement="left" target="_blank" title="QQ客服" ><span class="fa fa-qq"></span></a>
